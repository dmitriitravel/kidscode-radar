...
export const schools: School[] = [
  {
    id: '1',
    name: 'Skysmart Pro',
    description: 'Ведущая онлайн-школа программирования для детей от Skysmart. Обучение на реальных проектах с персональными наставниками-практиками. Даем навыки и знания для будущей IT-карьеры.',
    rating: 4.9,
    reviewCount: 628,
    ageRange: '8-17 лет',
    ...
    specialFeatures: ['Преподаватели-практики из IT', 'Реальные проекты для портфолио', 'Индивидуальные и групповые занятия', 'Обучение по игровой методике'],
